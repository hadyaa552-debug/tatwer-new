    ...
    <>
      ...
      <header className="header">
        <div className="header-content">
          <div className="logo">IL Monte Galala</div>
          <nav>
            <ul>
              <li><a href="#hero">الرئيسية</a></li>
              <li><a href="#overview">المشروع</a></li>
              <li><a href="#units">الوحدات</a></li>
              <li><a href="#amenities">المرافق</a></li>
              <li><a href="#contact">تواصل معنا</a></li>
            </ul>
          </nav>
          <a href="#contact" className="cta-btn">احجز الآن</a>
        </div>
      </header>
      ...
      <section id="hero" className="hero">
        <div>
          ...
          <p style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>أبراج فندقية فاخرة - تطوير مصر</p>
          <p style={{ fontSize: '1.1rem', opacity: 0.85, maxWidth: '600px' }}>
            لأول مرة على البحر الأحمر: أبراج سكنية على البحر مباشرة بارتفاع يصل لـ 22 دور على جبل الجلالة، العين السخنة
          </p>
